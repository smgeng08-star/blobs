...
gameServer3.config.playerMassDecayRate = 0.0035; // Progressive decay rate (scales dynamically with mass)
...
gameServer3.config.ejectMass = 15; // Balanced 15 mass unit (smooth and satisfying growth)
