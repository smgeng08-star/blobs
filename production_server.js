...
gameServer3.config.playerStartMass = 400; // 400 starting mass for mega action & instant splitting
...
gameServer3.config.ejectMass = 30; // Ejected mass unit
gameServer3.config.ejectMassLoss = 0; // 0 mass loss on shooting W in Self-Feed server (every W you shoot and eat GROWS you!)
gameServer3.config.ejectMassCooldown = 10; // Super fast W ejection
